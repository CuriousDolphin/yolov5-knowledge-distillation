...
from models.yolo_kd_fi import Model
...
from utils.loss import ComputeLossImitation
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        model = Model(cfg or ckpt['model'].yaml, ch=3, nc=nc, anchors=hyp.get('anchors'),device=device).to(device)  # create
    ...
    compute_loss = ComputeLossImitation(model)  # init loss class
